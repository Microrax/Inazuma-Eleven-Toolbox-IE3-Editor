...
namespace Inazuma_Eleven_Toolbox.Forms
{
    public partial class Save_Editor : Form
    {
        ...
        public sbyte[] ModifiedSBlock = null;
        ...
        void SaveMove(ComboBox MoveName,int PlayerIndex, int MoveIndex)
        {
            ...
            block[(0x38 + (MoveIndex * 2))] = (byte)(D.StrToMove[MoveName.Text] & 0xFF);
            block[(0x38 + (MoveIndex * 2) + 1)] = (byte)((D.StrToMove[MoveName.Text] >> 8) & 0xFF); 


            if (Moves.MoveGrowth.ContainsKey(MoveName.Text))
            {
                MoveEvolveType = Moves.MoveGrowth[MoveName.Text];
                block[0x44 + MoveIndex] = Moves.SetNewLevel(Moves.GetMinMoveLevel(MoveEvolveType), MoveEvolveType);
        ...
        void SetStat(int PlayerIndex, sbyte Value, int Patchoffset)
        {

            int PlayerOffset = (PlayerIndex * length);
            byte[] block = ModifiedBlock.Skip(PlayerOffset + PlayerStartOffset).Take(length).ToArray();
            block[Patchoffset] = (byte)Value;
            ModifiedBlock = FileIO.WriteData(ModifiedBlock, PlayerOffset + PlayerStartOffset, block, block.Length);
            LoadPlayer();
        ...
        {
            SetConsumablePoints(DataGridviewIndexFromCell(dataGridView1.CurrentRow.Index), 20, 0x18); // FP
            SetConsumablePoints(DataGridviewIndexFromCell(dataGridView1.CurrentRow.Index), 20, 0x1A); // TP
        ...
        {
            SetStat(DataGridviewIndexFromCell(dataGridView1.CurrentRow.Index), (sbyte)numericUpDown8.Value, 0x4F);

        }

        private void numericUpDown9_ValueChanged(object sender, EventArgs e)
        {
            SetStat(DataGridviewIndexFromCell(dataGridView1.CurrentRow.Index), (sbyte)numericUpDown9.Value, 0x4F + 1);
        ...
        private void numericUpDown10_ValueChanged(object sender, EventArgs e)
        {
            ...
            SetStat(DataGridviewIndexFromCell(dataGridView1.CurrentRow.Index), (sbyte)numericUpDown10.Value, 0x4F + 3);
        }

        private void numericUpDown11_ValueChanged(object sender, EventArgs e)
        {
            SetStat(DataGridviewIndexFromCell(dataGridView1.CurrentRow.Index), (sbyte)numericUpDown11.Value, 0x4F + 2);

        }

        private void numericUpDown12_ValueChanged(object sender, EventArgs e)
        {
            SetStat(DataGridviewIndexFromCell(dataGridView1.CurrentRow.Index), (sbyte)numericUpDown12.Value, 0x4F + 4);
       
        }

        private void numericUpDown13_ValueChanged(object sender, EventArgs e)
        {
            SetStat(DataGridviewIndexFromCell(dataGridView1.CurrentRow.Index), (sbyte)numericUpDown13.Value, 0x4F + 6);

        }

        private void numericUpDown14_ValueChanged(object sender, EventArgs e)
        {
            SetStat(DataGridviewIndexFromCell(dataGridView1.CurrentRow.Index), (sbyte)numericUpDown14.Value, 0x4F + 5);
        ...
        {
            SaveMove(comboBox5, dataGridView1.CurrentRow.Index, 4);
        }
        ...
        {
            SaveMove(comboBox1, dataGridView1.CurrentRow.Index, 0);
        }
        ...
        {
            SaveMove(comboBox2, dataGridView1.CurrentRow.Index, 1);
        }

        private void comboBox3_SelectedIndexChanged(object sender, EventArgs e)
        {
            SaveMove(comboBox3, dataGridView1.CurrentRow.Index, 2);
        }

        private void comboBox4_SelectedIndexChanged(object sender, EventArgs e)
        {
            SaveMove(comboBox4, dataGridView1.CurrentRow.Index, 3);
        }

        private void comboBox6_SelectedIndexChanged(object sender, EventArgs e)
        {
            SaveMove(comboBox6, dataGridView1.CurrentRow.Index, 5);
        }
    }
}
